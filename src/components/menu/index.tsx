...
export default function HeaderBar() {
    ...
    const phoneNumber = '85987805592';
    const message = 'olá gostaria de conhecer seus produtos';
    const whatsappLink = `https://api.whatsapp.com/send/?phone=${phoneNumber}&text=${encodeURIComponent(message)}&type=phone_number&app_absent=0`;
            ...
            <div className="container mx-auto px-6 py-3">
                <div className="flex items-center justify-between">
                    <div className="hidden w-full text-gray-600 md:flex md:items-center">
                        ...
                        <span className="mx-1 text-sm">Fort-Ce</span>
                    </div>
                    <Link href="/" className="w-full text-gray-700 md:text-center text-2xl font-semibold">
                        Catalagos
                    </Link>
                    <div className="flex items-center justify-end w-full">
                        <Link href="/checkout" className="text-gray-600 px-4 focus:outline-none mx-4 sm:mx-0 hover:text-blue-600 transition-colors duration-200 ease-in-out">
                        ...
                        <Link
                            ...
                            className="text-gray-600 cursor-pointer mx-4 sm:mx-0 hover:text-green-500 transition-colors duration-200 ease-in-out"
                        >
                            <SiWhatsapp className="h-5 w-5 fill-current" />
                        </Link>
                        ...
                        <div className="flex sm:hidden">
                            ...
                            <button type="button" className="text-gray-600 hover:text-green-500 focus:outline-none focus:text-green-500" aria-label="toggle menu">
                                <SiWhatsapp className="h-6 w-6 fill-current" />
                            </button>
                        </div>
                    </div>
                </div>
